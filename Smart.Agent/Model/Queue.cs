...
namespace Smart.Agent.Model
{
    public class Queue
    {
        ...
        public void LoadLcmQueue()
        {
            ...
            CommandQueue.Add(new Queue
                { SequenceId = 2, CommandName = "POWER ON", CommandType = Constant.CommandType.PowerOn, ExpectedPacketSize = 5, CommBytes = _command.PowerOn(), MaxRetry = 3, RetryWait= _defaultRetryWait, WaitForNext = 20, MoveNext = true });
            CommandQueue.Add(new Queue
